...
func init() {
	operation.Register(&Match{})
}

type Match struct{}

func (s *Match) Name() string { return Name }
...
func (s *Match) Run(ctx context.Context, v variable.Variable, value interface{}, data interface{}, cache *cache.Cache) (bool, error) {
