...
func TestHas(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			OperationValue: `[1]`,
			ParsedValue:    []interface{}{float64(1)},
			Result:         true,
		},
		{
			Variable: mockVariable{
			...
			OperationValue: `[2]`,
			ParsedValue:    []interface{}{float64(2)},
			Result:         true,
		},
		{
			Variable: mockVariable{
